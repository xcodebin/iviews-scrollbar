<template>
    <div :class="classes" ref="cell">
        ...
        <template v-if="renderType === 'html'"><span v-html="row[column.key]===''?'----':row[column.key]"></span></template>
        <template v-if="renderType === 'normal'"><span>{{row[column.key]===""?'----':row[column.key]}}</span></template>
